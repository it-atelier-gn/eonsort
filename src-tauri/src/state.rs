...
pub struct AppState {
    ...
    pub places_cancel: Arc<AtomicBool>,
    pub fetching_places: Mutex<bool>,
    pub tagging: Mutex<bool>,
    pub quality_cancel: Arc<AtomicBool>,
    pub fetching_quality: Mutex<bool>,
    pub face_cancel: Arc<AtomicBool>,
    pub hunting_faces: Mutex<bool>,
}
...
impl Default for AppState {
    fn default() -> Self {
        Self {
            ...
            places_cancel: Arc::new(AtomicBool::new(false)),
            fetching_places: Mutex::new(false),
            tagging: Mutex::new(false),
            quality_cancel: Arc::new(AtomicBool::new(false)),
            fetching_quality: Mutex::new(false),
            face_cancel: Arc::new(AtomicBool::new(false)),
            hunting_faces: Mutex::new(false),
        }
    }
}
