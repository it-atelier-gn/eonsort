...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::get_scene_fit,
            commands::set_scene_fit,
            commands::clear_scene_fit,
            commands::fit_scene_with_model,
            commands::detect_objects,
            commands::depth_model_status,
            commands::install_depth_model,
            commands::cancel_depth_install,
            commands::estimate_depth,
            commands::upright_model_status,
            commands::install_upright_model,
            commands::cancel_upright_install,
            commands::guess_upright,
            commands::fill_with_service,
            commands::diffuse_model_status,
            commands::install_diffuse_model,
            commands::cancel_diffuse_install,
            commands::fill_here,
        ])
